...
def velocity_publisher():
    ...
    # Create a Publishr and pubish a topic named /turtle1/cmd_vel. 
    # The type of message is geometry_msgs::Twist and the queue size is 10. 
    ...
    while not rospy.is_shutdown():
        ...
        rospy.loginfo("Publsh turtle velocity (2) command[%0.2f m/s, %0.2f rad/s]", vel_msg.linear.x, vel_msg.angular.z)
